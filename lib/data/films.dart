...
class FilmsData {
  final List<Film> _films = [
    Film(
      ...
      cast:
          "Robert Downey Jr., Chris Evans, Mark Ruffalo, Chris Hemsworth, Scarlett Johansson, Jeremy Renner, Don Cheadle, Paul Rudd, Brie Larson, Karen Gillan, Danai Gurira, Josh Brolin",
    ...
    Film(
      ...
      cast:
          "Chris Pratt, Zoe Saldana, Dave Bautista, Lee Pace, Michael Rooker, Karen Gillan, Djimon Hounsou, John C. Reilly, Glenn Close, Benicio del Toro",
      genre: ["Azione", "Fantascienza", "Avventura"],
    ...
    Film(
      ...
      cast:
          "Robert Downey Jr., Gwyneth Paltrow, Don Cheadle, Guy Pearce, Rebecca Hall, Ty Simpkins, Stephanie Szostak, James Badge Dale, Jon Favreau, Ben Kingsley",
      genre: ["Azione", "Fantascienza"],
    ...
    Film(
      ...
      direction: "Jon Watts",
      cast:
          "Tom Holland, Michael Keaton, Jon Favreau, Zendaya: Michelle, Donald Glover, Tyne Daly, Marisa Tomei, Robert Downey Jr.",
    ...
    Film(
      ...
      duration: Duration(minutes: 130),
      plot:
          "Thor viene imprigionato e, privato del proprio martello, si ritrova a dover combattere contro Hulk ed Hela. Inoltre deve riuscire a raggiungere Asgard e fermare Ragnarok, la distruzione del suo proprio mondo.",
